...
public final class AC implements Externalizable
{
    ...
    public final AC noGrid(final int... array) {
        for (int i = array.length - 1; i >= 0; --i) {
            ...
            this.makeSize(index);
            this.cList.get(index).setNoGrid(true);
        }
        return this;
    }
    ...
    public final AC fill(final int... array) {
        for (int i = array.length - 1; i >= 0; --i) {
            final int index = array[i];
            this.makeSize(index);
            this.cList.get(index).setFill(true);
        }
        return this;
    }
    ...
    public final AC sizeGroup(final String sizeGroup, final int... array) {
        for (int i = array.length - 1; i >= 0; --i) {
            final int index = array[i];
            this.makeSize(index);
            this.cList.get(index).setSizeGroup(sizeGroup);
        }
        return this;
    }
    ...
    public final AC size(final String s, final int... array) {
        ...
        for (int i = array.length - 1; i >= 0; --i) {
            final int index = array[i];
            this.makeSize(index);
            this.cList.get(index).setSize(boundSize);
        }
        return this;
    }
    ...
    public final AC gap(final String s, final int... array) {
        ...
        for (int i = array.length - 1; i >= 0; --i) {
            ...
            this.makeSize(index);
            if (gapAfter != null) {
                this.cList.get(index).setGapAfter(gapAfter);
            }
        }
        return this;
    }
    ...
    public final AC align(final String s, final int... array) {
        ...
        for (int i = array.length - 1; i >= 0; --i) {
            final int index = array[i];
            this.makeSize(index);
            this.cList.get(index).setAlign(align);
        }
        return this;
    }
    ...
    public final AC growPrio(final int growPriority, final int... array) {
        for (int i = array.length - 1; i >= 0; --i) {
            final int index = array[i];
            this.makeSize(index);
            this.cList.get(index).setGrowPriority(growPriority);
        }
        return this;
    }
    ...
    public final AC grow(final float value, final int... array) {
        final Float grow = new Float(value);
        for (int i = array.length - 1; i >= 0; --i) {
            final int index = array[i];
            this.makeSize(index);
            this.cList.get(index).setGrow(grow);
        }
        return this;
    }
    ...
    public final AC shrinkPrio(final int shrinkPriority, final int... array) {
        for (int i = array.length - 1; i >= 0; --i) {
            final int index = array[i];
            this.makeSize(index);
            this.cList.get(index).setShrinkPriority(shrinkPriority);
        }
        return this;
    }
    ...
    public final AC shrink(final float value, final int... array) {
        final Float shrink = new Float(value);
        for (int i = array.length - 1; i >= 0; --i) {
            final int index = array[i];
            this.makeSize(index);
            this.cList.get(index).setShrink(shrink);
        }
        return this;
    }
    ...
    private void makeSize(final int minCapacity) {
        if (this.cList.size() <= minCapacity) {
            this.cList.ensureCapacity(minCapacity);
            for (int i = this.cList.size(); i <= minCapacity; ++i) {
                this.cList.add(new DimConstraint());
            }
        }
    }
