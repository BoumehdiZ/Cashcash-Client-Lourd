...
public class BoundSize implements Serializable
{
    ...
    final UnitValue getSize(final int i) {
        switch (i) {
            case 0: {
                return this.min;
            }
    ...
    static {
        ...
        LayoutUtil.setDelegate(BoundSize.class, new PersistenceDelegate() {
            ...
            protected Expression instantiate(final Object value, final Encoder encoder) {
                final BoundSize boundSize = (BoundSize)value;
                return new Expression(value, BoundSize.class, "new", new Object[] { boundSize.getMin(), boundSize.getPreferred(), boundSize.getMax(), boundSize.getGapPush(), boundSize.getConstraintString() });
            }
        });
    }
}
