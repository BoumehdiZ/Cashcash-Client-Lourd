...
public final class LC implements Externalizable
{
    ...
    public final void setHideMode(final int n) {
        if (n < 0 || n > 3) {
    ...
    public final void setPackHeightAlign(final float b) {
        this.phAlign = Math.max(0.0f, Math.min(1.0f, b));
    }
    ...
    public final void setPackWidthAlign(final float b) {
        this.pwAlign = Math.max(0.0f, Math.min(1.0f, b));
    }
