...
public final class CC implements Externalizable
{
    ...
    public final CC growX(final float value) {
        this.hor.setGrow(new Float(value));
        return this;
    }
    ...
    public final CC shrinkX(final float value) {
        this.hor.setShrink(new Float(value));
        return this;
    }
    ...
    public final CC shrinkY(final float value) {
        this.ver.setShrink(new Float(value));
        return this;
    }
    ...
    public void setDockSide(final int n) {
        if (n < -1 || n > 3) {
    ...
    public void setHideMode(final int n) {
        if (n < -1 || n > 3) {
