...
public final class Grid
{
    ...
    public Grid(final ContainerWrapper container, final LC lc, final AC rowConstr, final AC colConstr, final Map<ComponentWrapper, CC> map, final ArrayList<LayoutCallback> callbackList) {
        ...
        while (i < components.length) {
            ...
            if (n5 == 3) {
                ...
                if (array3 != null || cc.isExternal()) {
                    final CompWrap e = new CompWrap(componentWrapper, cc, n5, array3, array4);
                    final Cell cell = this.grid.get(null);
                    if (cell == null) {
                        this.grid.put(null, new Cell(e));
                    }
                    else {
                        cell.compWraps.add(e);
                    }
        ...
        if (n3 > 0 || n4 > 0) {
            ...
            for (final Cell cell3 : this.grid.values()) {
                for (int k = 0; k < cell3.compWraps.size(); ++k) {
                    final CompWrap e2 = cell3.compWraps.get(k);
                    final String sizeGroup = e2.cc.getHorizontal().getSizeGroup();
                    final String sizeGroup2 = e2.cc.getVertical().getSizeGroup();
                    if (sizeGroup != null || sizeGroup2 != null) {
                        if (sizeGroup != null && hashMap != null) {
                            addToSizeGroup((HashMap<String, int[]>)hashMap, sizeGroup, e2.horSizes);
                        }
                        if (sizeGroup2 != null && hashMap2 != null) {
                            addToSizeGroup((HashMap<String, int[]>)hashMap2, sizeGroup2, e2.verSizes);
                        }
                        list2.add(e2);
                    }
                }
            ...
            for (int l = 0; l < list2.size(); ++l) {
                final CompWrap compWrap = list2.get(l);
                if (hashMap != null) {
                    compWrap.setSizes(hashMap.get(compWrap.cc.getHorizontal().getSizeGroup()), true);
                }
                if (hashMap2 != null) {
        ...
        if (n3 > 0 || n4 > 0) {
            ...
            for (final Cell cell4 : this.grid.values()) {
                for (int index = 0; index < cell4.compWraps.size(); ++index) {
                    final CompWrap e3 = cell4.compWraps.get(index);
                    final String sizeGroup3 = e3.cc.getHorizontal().getSizeGroup();
                    final String sizeGroup4 = e3.cc.getVertical().getSizeGroup();
                    if (sizeGroup3 != null || sizeGroup4 != null) {
                        if (sizeGroup3 != null && hashMap3 != null) {
                            addToSizeGroup((HashMap<String, int[]>)hashMap3, sizeGroup3, e3.horSizes);
                        }
                        if (sizeGroup4 != null && hashMap4 != null) {
                            addToSizeGroup((HashMap<String, int[]>)hashMap4, sizeGroup4, e3.verSizes);
                        }
                        list3.add(e3);
                    }
                }
            }
            for (int index2 = 0; index2 < list3.size(); ++index2) {
                final CompWrap compWrap2 = list3.get(index2);
                if (hashMap3 != null) {
                    compWrap2.setSizes(hashMap3.get(compWrap2.cc.getHorizontal().getSizeGroup()), true);
                }
                if (hashMap4 != null) {
                    compWrap2.setSizes(hashMap4.get(compWrap2.cc.getVertical().getSizeGroup()), false);
                }
            }
        }
        if (b) {
        ...
        for (final Cell cell5 : this.grid.values()) {
            ...
            for (int index3 = 0, n9 = access$200.size() - 1; index3 <= n9; ++index3) {
                final CompWrap compWrap3 = access$200.get(index3);
                final ComponentWrapper componentWrapper3 = (index3 > 0) ? access$200.get(index3 - 1).comp : null;
                final ComponentWrapper componentWrapper4 = (index3 < n9) ? access$200.get(index3 + 1).comp : null;
                compWrap3.calcGaps(componentWrapper3, (componentWrapper3 != null) ? getCC(componentWrapper3, map) : null, componentWrapper4, (componentWrapper4 != null) ? getCC(componentWrapper4, map) : null, getCC(compWrap3.comp, map).getTag(), cell5.flowx, leftToRight);
            }
        }
        this.dockOffX = getDockInsets(this.colIndexes);
        this.dockOffY = getDockInsets(this.rowIndexes);
        for (int m = 0; m < rowConstr.getCount(); ++m) {
            this.rowIndexes.add(m);
        }
        for (int i2 = 0; i2 < colConstr.getCount(); ++i2) {
    ...
    private UnitValue[] getPos(final ComponentWrapper componentWrapper, final CC cc) {
        ...
        if (this.callbackList != null) {
            for (int index = 0; index < this.callbackList.size() && position == null; position = this.callbackList.get(index).getPosition(componentWrapper), ++index) {}
        }
    ...
    private void wrap(final int[] array, final BoundSize value) {
        ...
        if (value != null) {
            ...
            this.wrapGapMap.put(array[flowX], value);
        }
        if (flowX != 0) {
    ...
    private static void sortCellsByPlatform(final Collection<Cell> collection, final ContainerWrapper containerWrapper) {
        ...
        for (final Cell cell : collection) {
                ...
                if (char1 == '+' || char1 == '_') {
                    ...
                    if (tagForChar != null) {
                        for (int j = 0; j < cell.compWraps.size(); ++j) {
                            final CompWrap e = cell.compWraps.get(j);
                            if (tagForChar.equals(e.cc.getTag())) {
                                if (Character.isUpperCase(buttonOrder.charAt(i))) {
                                    final int pixels = PlatformDefaults.getMinimumButtonWidth().getPixels(0.0f, containerWrapper, e.comp);
                                    if (pixels > e.horSizes[0]) {
                                        e.horSizes[0] = pixels;
                                    }
                                    correctMinMax(e.horSizes);
                                }
                                list.add(e);
                                if (n != 0) {
                                    ((compWrap != null) ? compWrap : e).mergeGapSizes(array, cell.flowx, compWrap == null);
                                    if (n2 != 0) {
                                        e.forcedPushGaps = 1;
                                        n = 0;
                                        n2 = 0;
            ...
            if (list.size() > 0) {
                final CompWrap compWrap2 = list.get(list.size() - 1);
                if (n != 0) {
                    compWrap2.mergeGapSizes(array, cell.flowx, false);
                    if (n2 != 0) {
                        compWrap2.forcedPushGaps |= 0x2;
                    }
                }
                if (compWrap2.cc.getHorizontal().getGapAfter() == null) {
                    compWrap2.setGaps(array2, 3);
                }
                final CompWrap compWrap3 = list.get(0);
                if (compWrap3.cc.getHorizontal().getGapBefore() == null) {
                    compWrap3.setGaps(array2, 1);
                }
            }
    ...
    private static HashMap<String, Integer> addToEndGroup(HashMap<String, Integer> hashMap, final String s, final int i) {
        if (s != null) {
            if (hashMap == null) {
                hashMap = new HashMap<String, Integer>(2);
            }
            final Integer n = hashMap.get(s);
            if (n == null || i > n) {
                hashMap.put(s, i);
            }
        }
            ...
            for (final int intValue2 : set2) {
                ...
                if (cell != null) {
                    ...
                    if ((!b4 && cell.compWraps.size() > 1) || convertSpanToSparseGrid > 1) {
                        final LinkedDimGroup e = new LinkedDimGroup("p," + intValue2, convertSpanToSparseGrid, (int)(b4 ? 1 : 0), !b, b3);
                        e.setCompWraps(cell.compWraps);
                        list.add(e);
                    }
                    else {
                        for (int i = 0; i < cell.compWraps.size(); ++i) {
                            ...
                            for (int j = 0; j <= list.size() - 1; ++j) {
                                final LinkedDimGroup linkedDimGroup = list.get(j);
                                if (linkedDimGroup.linkCtx == s || (s != null && s.equals(linkedDimGroup.linkCtx))) {
                            ...
                            if (!b7) {
                                final LinkedDimGroup e2 = new LinkedDimGroup(s, 1, b6 ? 2 : 1, !b, b3);
                                e2.addCompWrap(compWrap);
                                list.add(e2);
                            }
                        }
                    }
    ...
    private void setCell(final int n, final int n2, final Cell value) {
    ...
    private void addDockingCell(final int[] array, final int n, final CompWrap compWrap) {
        ...
        switch (n) {
            ...
            case 3: {
                ...
                if (n == 1) {
                    final int n7 = 1;
                    array[n7] = (n8 = array[n7]) + 1;
                }
                else {
                    final int n9 = 3;
                    array[n9] = (n8 = array[n9]) - 1;
                }
                j = n8;
                i = array[0];
        ...
        this.colIndexes.add(j);
        this.grid.put((i << 16) + j, new Cell(compWrap, n2, n3, n2 > 1));
    }
    ...
    private static void setCompWrapBounds(final ContainerWrapper containerWrapper, final int[] array, final ArrayList<CompWrap> list, final UnitValue unitValue, final int n, final int n2, final boolean b, final boolean b2) {
        ...
        int n3 = n;
        final int a = n2 - sum;
        if (a > 0 && correctAlign != null) {
            final int min = Math.min(a, Math.max(0, correctAlign.getPixels((float)a, containerWrapper, null)));
            n3 += (b2 ? (-min) : min);
        }
        int i = 0;
        int n4 = 0;
        while (i < list.size()) {
            final CompWrap compWrap = list.get(i);
            if (b2) {
                final int n5 = n3 - array[n4++];
                compWrap.setDimBounds(n5 - array[n4], array[n4], b);
                n3 = n5 - array[n4++];
            }
            else {
                final int n6 = n3 + array[n4++];
                compWrap.setDimBounds(n6, array[n4], b);
                n3 = n6 + array[n4++];
            }
            ++i;
        }
    ...
    private static synchronized void putSizesAndIndexes(final Object key, final int[] array, final int[] array2, final boolean b) {
        if (Grid.PARENT_ROWCOL_SIZES_MAP == null) {
            Grid.PARENT_ROWCOL_SIZES_MAP = new WeakHashMap[] { new WeakHashMap(4), new WeakHashMap(4) };
        }
        Grid.PARENT_ROWCOL_SIZES_MAP[!b].put(key, new int[][] { array2, array });
    }
    
    static synchronized int[][] getSizesAndIndexes(final Object key, final boolean b) {
        if (Grid.PARENT_ROWCOL_SIZES_MAP == null) {
            return null;
        }
        return Grid.PARENT_ROWCOL_SIZES_MAP[!b].get(key);
    }
    
    private static synchronized void saveGrid(final ComponentWrapper componentWrapper, final LinkedHashMap<Integer, Cell> value) {
        if (Grid.PARENT_GRIDPOS_MAP == null) {
            Grid.PARENT_GRIDPOS_MAP = new WeakHashMap<Object, LinkedHashMap<Integer, Cell>>();
        }
        Grid.PARENT_GRIDPOS_MAP.put(componentWrapper.getComponent(), value);
    }
    
    static synchronized HashMap<Object, int[]> getGridPositions(final Object key) {
        if (Grid.PARENT_GRIDPOS_MAP == null) {
            return null;
        }
        final LinkedHashMap<Integer, Cell> linkedHashMap = Grid.PARENT_GRIDPOS_MAP.get(key);
    ...
    private static class LinkedDimGroup
    {
        ...
        private void addCompWrap(final CompWrap e) {
            this._compWraps.add(e);
            this.sizes = null;
        }
    ...
    private static class Cell
    {
        ...
        private Cell(final CompWrap e, final int spanx, final int spany, final boolean flowx) {
            this.compWraps = new ArrayList<CompWrap>(1);
            this.hasTagged = false;
            if (e != null) {
                this.compWraps.add(e);
            }
            this.spanx = spanx;
            this.spany = spany;
            this.flowx = flowx;
