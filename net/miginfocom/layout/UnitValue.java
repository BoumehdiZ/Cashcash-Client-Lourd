...
public final class UnitValue implements Serializable
{
    ...
    public UnitValue(final float f) {
    ...
    public static synchronized void addGlobalUnitConverter(final UnitConverter e) {
        if (e == null) {
            throw new NullPointerException();
        }
        UnitValue.CONVERTERS.add(e);
    }
    
    public static synchronized boolean removeGlobalUnitConverter(final UnitConverter o) {
        return UnitValue.CONVERTERS.remove(o);
    }
    ...
    static {
        ...
        LayoutUtil.setDelegate(UnitValue.class, new PersistenceDelegate() {
            @Override
            protected Expression instantiate(final Object value, final Encoder encoder) {
                ...
                return new Expression(value, ConstraintParser.class, "parseUnitValueOrAlign", new Object[] { unitValue.getConstraintString(), unitValue.isHorizontal() ? Boolean.TRUE : Boolean.FALSE, null });
            }
        });
    }
}
