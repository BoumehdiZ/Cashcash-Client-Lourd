...
public final class MigLayout implements LayoutManager2, Externalizable
{
    ...
    public void addLayoutCallback(final LayoutCallback e) {
        if (e == null) {
        ...
        this.callbackList.add(e);
    }
    
    public void removeLayoutCallback(final LayoutCallback o) {
        if (this.callbackList != null) {
            this.callbackList.remove(o);
        }
    }
    ...
    private int constrain(final ContainerWrapper containerWrapper, final int a, final int n, final BoundSize boundSize) {
        if (boundSize == null) {
            return a;
        }
        int pixels = a;
        ...
        if (preferred != null) {
            pixels = preferred.getPixels((float)n, containerWrapper, containerWrapper);
        }
        final int constrain = boundSize.constrain(pixels, (float)n, containerWrapper);
        return boundSize.getGapPush() ? Math.max(a, constrain) : constrain;
    }
